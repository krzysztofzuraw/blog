...
export type Unnamed_2_Query = { __typename?: 'Query' } & {
  site: Maybe<
    { __typename?: 'Site' } & {
      siteMetadata: Maybe<{ __typename?: 'SiteSiteMetadata' } & Pick<SiteSiteMetadata, 'siteName'>>;
    }
  >;
};
...
export type Unnamed_3_Query = { __typename?: 'Query' } & {
  ...
  allMarkdownRemark: Maybe<
    { __typename?: 'MarkdownRemarkConnection' } & {
      edges: Array<
        { __typename?: 'MarkdownRemarkEdge' } & {
          node: { __typename?: 'MarkdownRemark' } & Pick<MarkdownRemark, 'id' | 'excerpt'> & {
              frontmatter: Maybe<
  ...
  site: Maybe<
    { __typename?: 'Site' } & {
      siteMetadata: Maybe<
        { __typename?: 'SiteSiteMetadata' } & Pick<
          SiteSiteMetadata,
          'siteName' | 'siteUrl' | 'author'
        >
      >;
    }
  >;
  markdownRemark: Maybe<
    { __typename?: 'MarkdownRemark' } & Pick<MarkdownRemark, 'html' | 'excerpt'> & {
        frontmatter: Maybe<
          { __typename?: 'MarkdownRemarkFrontmatter' } & Pick<
            MarkdownRemarkFrontmatter,
