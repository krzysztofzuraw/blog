...
export enum FileFieldsEnum {
  ...
  ChildMarkdownRemarkFrontmatterTwitter = 'childMarkdownRemark___frontmatter___twitter',
  ChildMarkdownRemarkExcerpt = 'childMarkdownRemark___excerpt',
  ChildMarkdownRemarkRawMarkdownBody = 'childMarkdownRemark___rawMarkdownBody',
  ChildMarkdownRemarkFileAbsolutePath = 'childMarkdownRemark___fileAbsolutePath',
  ChildMarkdownRemarkFieldsSourceInstanceName = 'childMarkdownRemark___fields___sourceInstanceName',
...
export enum MarkdownRemarkFieldsEnum {
  ...
  FrontmatterTwitter = 'frontmatter___twitter',
  Excerpt = 'excerpt',
...
export enum SiteFieldsEnum {
  ...
  SiteMetadataSocialSpeakerDeck = 'siteMetadata___social___speakerDeck',
  Port = 'port',
  Host = 'host',
  Polyfill = 'polyfill',
...
export type SiteSiteMetadataSocial = {
  ...
  speakerDeck?: Maybe<Scalars['String']>,
};
...
export type SiteSiteMetadataSocialFilterInput = {
  ...
  speakerDeck?: Maybe<StringQueryOperatorInput>,
};
...
export type Unnamed_1_Query = (
  ...
  & { site: Maybe<(
    ...
    & { siteMetadata: Maybe<(
      { __typename?: 'SiteSiteMetadata' }
      & Pick<SiteSiteMetadata, 'siteName' | 'description' | 'author'>
    )> }
  )> }
);
...
export type MicroblogIndexPageQueryVariables = {};


export type MicroblogIndexPageQuery = (
  { __typename?: 'Query' }
  & { allMarkdownRemark: (
    { __typename?: 'MarkdownRemarkConnection' }
    & { edges: Array<(
      ...
      & { node: (
        ...
        & { frontmatter: Maybe<(
          { __typename?: 'MarkdownRemarkFrontmatter' }
          & Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'slug' | 'twitter' | 'tags'>
        )> }
      ) }
    )> }
  ) }
...
export type BlogPostBySlugQuery = (
  ...
  & { markdownRemark: Maybe<(
    ...
    & { frontmatter: Maybe<(
      { __typename?: 'MarkdownRemarkFrontmatter' }
      & Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'tags' | 'slug'>
    )> }
  )> }
);
