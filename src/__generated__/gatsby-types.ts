...
type SitePluginPluginOptionsFilterInput = {
  ...
  readonly playsinline: Maybe<BooleanQueryOperatorInput>;
...
type SitePageFieldsEnum =
  ...
  | 'pluginCreator.pluginOptions.muted'
  | 'pluginCreator.pluginOptions.autoplay'
  | 'pluginCreator.pluginOptions.height'
  | 'pluginCreator.pluginOptions.preload'
  | 'pluginCreator.pluginOptions.playsinline'
  | 'pluginCreator.pluginOptions.controls'
  | 'pluginCreator.pluginOptions.loop'
  ...
  | 'pluginCreator.pluginOptions.feeds.match'
...
type SitePluginFieldsEnum =
  ...
  | 'pluginOptions.plugins.pluginOptions.muted'
  | 'pluginOptions.plugins.pluginOptions.autoplay'
  | 'pluginOptions.plugins.pluginOptions.height'
  | 'pluginOptions.plugins.pluginOptions.preload'
  | 'pluginOptions.plugins.pluginOptions.playsinline'
  | 'pluginOptions.plugins.pluginOptions.controls'
  | 'pluginOptions.plugins.pluginOptions.loop'
  ...
  | 'pluginOptions.width'
  | 'pluginOptions.muted'
  | 'pluginOptions.autoplay'
  | 'pluginOptions.height'
  | 'pluginOptions.preload'
  | 'pluginOptions.playsinline'
...
type BlogListPageQueryVariables = Exact<{ [key: string]: never; }>;


type BlogListPageQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
