...
<BlogPostImage src="2016-12-04-aws-1" alt="Policy for IAM user" />
...
<BlogPostImage src="2016-12-04-aws-2" alt="Policy for S3 bucket" />
...
<BlogPostImage src="2016-12-04-aws-3" alt="Static files inside S3" />

Right now when I run my server I can see the location of my static
files:

<BlogPostImage src="2016-12-04-aws-4" alt="Static files loaded from S3" />
...
<BlogPostImage src="2016-12-04-aws-5" alt="Media files in S3" />
...
<BlogPostImage src="2016-12-11-pipeline" alt="Pipeline configuration" />
...
<BlogPostImage src="2016-12-11-job" alt="Job details" />
...
<BlogPostImage src="2016-12-18-lambda-config" alt="AWS Lambda configuration" />
...
<BlogPostImage src="2016-12-18-result" alt="AWS Lambda test function result" />
...
<BlogPostImage src="2017-01-15-topic" alt="SNS topic" />
...
<BlogPostImage src="2017-01-15-config" alt="Transcoder SNS subscription" />
...
<BlogPostImage src="2017-01-22-message" alt="Transcode complete message" />
