  ...
  return (
    <Layout location="uses">
      ...
      <Stack>
        ...
        <p>
          I spend too much time lurking through other people tooling and too little time spend on
        ...
        <p>
          ...
          <Link to="https://www.google.com/chrome/">browser</Link>. I plan my day in plain text and
          calendar. I'm using Apple products. I brew coffee in Chemex or V60.
        </p>
        <p>
