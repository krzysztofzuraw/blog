...
const IndexPage: FunctionComponent = () => {
  return (
    <Layout>
      ...
      <p>Welcome to my site. My name is Krzysztof Żuraw. About me:</p>
      <ul>
      ...
      <p>
        ...
        <Link to="https://gocarrots.org/">Geek Girls Carrots</Link>. I like to organise events - I’m
        co-organizer of{' '}
        <Link to="https://www.meetup.com/pl-PL/WrocTypeScript/">Wrocław TypeScript</Link> meetup and{' '}
        <Link to="https://djangogirls.org/wroclaw/">Django Girls Wrocław</Link>. If you need help
        with preparing tech event do not hesitate to contact me.
      </p>
    </Layout>
  );
};
