...
date: 2016-01-08
permalink: "/blog/2016/geodjango-leaflet-part-two/index.html"
---

**This is the second post from GeoDjango i Leaflet.js series. You can
find the previous post under this**
[link](/blog/2016/geodjango-and-leaflet.js-part-one/).
...
{% img "2016-01-08-geojson", "GeoJSON from GeoDjango", "GeoJSON from GeoDjango" %}
...
{% img "2016-01-08-leaflet", "Basic Leaflet.js map", "Basic Leaflet.js map" %}
