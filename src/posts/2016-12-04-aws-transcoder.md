...
{% img "2016-12-04-aws-1", "Policy for IAM user" %}
...
{% img "2016-12-04-aws-2", "Policy for S3 bucket" %}
...
{% img "2016-12-04-aws-3", "Static files inside S3" %}

Right now when I run my server I can see the location of my static
files:

{% img "2016-12-04-aws-4", "Static files loaded from S3" %}
...
{% img "2016-12-04-aws-5", "Media files in S3" %}
...
{% img "2016-12-11-pipeline", "Pipeline configuration" %}
...
{% img "2016-12-11-job", "Job details" %}
...
{% img "2016-12-18-lambda-config", "AWS Lambda configuration" %}
...
{% img "2016-12-18-result", "AWS Lambda test function result" %}
...
{% img "2017-01-15-topic", "SNS topic" %}
...
{% img "2017-01-15-config", "Transcoder SNS subscription" %}
...
{% img "2017-01-15-subscription", "Creating a SNS subscription" %}
...
{% img "2017-01-22-message", "Transcode complete message" %}
